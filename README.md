...
1. **Clone the repository:**
    ```bash
    git clone [https://github.com/omerjakoby/MARIO-RL-PPO.git](https://github.com/omerjakoby/MARIO-RL-PPO.git)
    cd MARIO-RL-PPO
    ```
...
* **You can find the pre-trained actor and critic checkpoints here:**
    **[Google Drive Link to Checkpoints]** https://drive.google.com/drive/folders/1c5TaCSCHSHkR-eTzTFp5GB3ktPPWsLbu?usp=sharing
